...
import { Github, Star, GitFork, Code2, Activity, ExternalLink, RefreshCw } from 'lucide-react';
  ...
  return (
    <section className="border-t border-line/60 py-20 sm:py-28">
      <div className="mx-auto w-full max-w-6xl px-6 sm:px-10">
        ...
        {/* Section Header matching sunnypatel.net */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* Key Metrics Cards (Left 4 cols) */}
          <div className="lg:col-span-4 grid grid-cols-2 gap-4">
            <div className="rounded-xl border border-line bg-surface p-5 shadow-panel flex flex-col justify-between">
          ...
          {/* Languages Breakdown (Middle 4 cols) */}
          <div className="lg:col-span-4 rounded-xl border border-line bg-surface p-6 shadow-panel flex flex-col justify-between">
            <div>
          ...
          {/* Popular Repositories List (Right 4 cols) */}
          <div className="lg:col-span-4 rounded-xl border border-line bg-surface p-6 shadow-panel flex flex-col justify-between">
            <div>
              <h3 className="font-display text-lg font-semibold text-bone mb-4 flex items-center gap-2">
