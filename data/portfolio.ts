...
export interface ExperienceItem {
  ...
  role: string;
  organization: string;
  organizationType?: 'contract' | 'internship' | 'fulltime' | 'academic' | 'project';
  period: string;
  location: string;
  description: string[];
  skills: string[];
...
export interface PortfolioData {
  ...
  detailedSkills: TechnicalSkillsDetailed;
}

export const portfolioData: PortfolioData = {
  name: "Ishaan Koradia",
  title: "AI Engineer & Data Science Developer",
  location: "San Jose / San Diego, CA (Remote Ready)",
  phone: "669-203-9160",
  bio: "AI Engineer specializing in LLM evaluation, agentic pipelines, Model Context Protocol (MCP), and production machine learning systems. B.S. in Cognitive Science (ML & Neural Computation) from UC San Diego.",
  ...
  stats: [
    {
      ...
      value: 95,
      suffix: "%",
      description: "Evaluation accuracy across 300+ context & failure strategies"
    },
    {
      label: "Weekly System Requests",
      value: 25,
      suffix: "k+",
      description: "Processed through serverless agentic canvas architectures"
    },
    {
      label: "Community Scale",
      value: 10,
      suffix: "k+",
      description: "Users served by parallelized Discord ML pipelines"
    },
    {
      label: "Academic GPA",
      value: 3.76,
      suffix: "",
      description: "UCSD Cognitive Science ML & Neural Computation"
    }
  ],

  education: {
    institution: "University of California, San Diego (UCSD)",
    degree: "B.S. in Cognitive Science (Specialization in Machine Learning & Neural Computation)",
    ...
    coursework: [
      ...
      "Neural Computation & Biological Networks",
    ...
    organizations: [
      ...
      "Cognitive Science Student Association (CSSA Web Team)",
      "Computer Science and Engineering Society (CSES Dev)"
    ]
  },

  learningNow: [
    "Agentic Workflows & Multi-Agent LangGraph Systems",
    "Advanced Model Context Protocol (MCP) Streamable Transports",
    "Instruction-Tuning & RLHF Optimization",
    "High-Throughput FastAPI & FastMCP Inference Servers",
    "Vector Database RAG Architecture & Context Routing"
  ],
  ...
  experience: [
    ...
    {
      id: "exp-ucsd-degree",
      role: "B.S. in Cognitive Science (Machine Learning & Neural Computation)",
  ...
  certifications: [
    {
      ...
      issuer: "Data Science & MLOps Certification",
      badgeColor: "#38bdf8",
    ...
    },
    {
      ...
      issuer: "Anthropic / AI Systems Infrastructure",
      badgeColor: "#a855f7",
  ...
  detailedSkills: {
    aiTools: ["ChatGPT", "Gemini", "Claude", "GitHub Copilot", "Sora", "Quillbot", "n8n"],
    technologies: [
      "LangChain",
    ...
    devTools: ["Git", "GitHub", "Docker", "Linux", "Bash", "Google Cloud Platform", "cronjob"],
  ...
  projects: [
    ...
    },
    {
      ...
      migratedDate: "Dec 2024",
      category: "Automation",
      image: "/images/notestaker-photo.png",
  ...
  skillCategories: [
    {
      ...
      skills: [
        ...
        { name: "LangChain & Agentic Workflows", level: 92, tag: "Agentic AI" },
        { name: "Model Context Protocol (MCP)", level: 94, tag: "Infrastructure" },
        { name: "PyTorch & TensorFlow", level: 85, tag: "Deep Learning" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "Docker & Linux / Bash", level: 88, tag: "DevOps / CI/CD" },
        { name: "asyncio & Concurrency", level: 92, tag: "High Throughput" },
        { name: "Pandas, NumPy, OpenCV", level: 95, tag: "Data Processing" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "D3.js / Matplotlib / Seaborn", level: 88, tag: "Dataviz" }
      ]
    }
  ]
};
