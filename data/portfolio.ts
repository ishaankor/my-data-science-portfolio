...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      detailedDescription: "React frontend and FastAPI-backed Python analytics engine using LangChain and RAG for automated exploratory data analysis.",
      tags: ["TypeScript", "React", "FastAPI", "Python", "LangChain"],
      githubUrl: "https://github.com/ishaankor/Datafy",
      featured: true,
      metrics: "Automated CSV RAG insights"
    },
    {
      id: "daily-motivation",
    ...
    {
      id: "surgery-statistics",
      title: "A Dive Into Surgery Statistics",
      year: "2024",
      category: "Data Visualization",
      description: "Interactive data visualization project analyzing factors influencing ICU stay duration after surgery using D3.js.",
      detailedDescription: "Uses D3.js and JavaScript to explore correlations between patient demographics, surgical parameters, and ICU recovery timelines.",
      tags: ["JavaScript", "D3.js", "HTML5", "CSS3", "Data Visualization"],
      githubUrl: "https://github.com/ishaankor/A-Dive-Into-Surgery-Statistics",
      featured: true,
      metrics: "Interactive D3.js surgery visualization"
    },
    {
      id: "childhood-obesity",
      title: "Childhood Obesity & Socioeconomic Analysis",
      year: "2023",
      category: "Machine Learning",
      description: "Data science investigation examining household characteristics, socioeconomic factors, and BMI classifications.",
      detailedDescription: "Jupyter Notebook statistical study analyzing multivariable correlations between family dynamics, income, and health outcomes.",
      tags: ["Jupyter Notebook", "Python", "Pandas", "Statsmodels", "Seaborn"],
      githubUrl: "https://github.com/ishaankor/Childhood-Obesity-Analysis",
      featured: false,
      metrics: "Multivariable statistical study"
    },
    {
      id: "minecraft-upkeeper",
      title: "Minecraft Server Upkeeper",
      year: "2023",
      category: "Automation",
      description: "Automating server uptime monitoring and maintenance tasks via Python and Selenium automation.",
      detailedDescription: "Python automation script running browser tasks to maintain server uptime, monitor status logs, and handle server restarts.",
      tags: ["Python", "Selenium", "Automation", "Web Scraping"],
      githubUrl: "https://github.com/ishaankor/Minecraft-Server-Upkeeper",
      featured: false,
      metrics: "Automated server health & uptime bot"
    },
    {
      id: "bikewatching-analysis",
      title: "Bikewatching Mobility Analysis",
      year: "2023",
      category: "Data Visualization",
      description: "Interactive web visualization analyzing urban bike-sharing trip origins, destinations, and temporal trends.",
      detailedDescription: "Web application rendering map-based trip paths, peak usage hours, and spatial density heatmaps.",
      tags: ["JavaScript", "HTML5", "CSS3", "Map dataviz"],
      githubUrl: "https://github.com/ishaankor/bikewatching-analysis",
      featured: false,
      metrics: "Urban mobility trip heatmaps"
    },
    {
      id: "canvas-files-merger",
      title: "Canvas Files Merger Utility",
      year: "2024",
      category: "Automation",
      description: "Python automation tool to batch-download, sort, and merge course documents from Canvas LMS into organized PDFs.",
      detailedDescription: "Parses course directories, converts slides and reading materials into standardized document indexes for offline study.",
      tags: ["Python", "PDF Processing", "Automation", "File Utility"],
      githubUrl: "https://github.com/ishaankor/Canvas-Files-Merger",
      featured: false,
      metrics: "Batch document processing"
    },
    {
      id: "ratings-recipes-analysis",
      title: "Recipe Ratings Data Exploration",
      year: "2024",
      category: "Data Visualization",
      description: "Web data project analyzing user recipe ratings, preparation times, and ingredient complexity correlations.",
      detailedDescription: "Processes large recipe datasets to visualize rating distributions, cooking duration impact, and sentiment trends.",
      tags: ["HTML", "JavaScript", "Pandas", "Dataviz"],
      githubUrl: "https://github.com/ishaankor/Ratings-Recipes-Analysis",
      featured: false,
      metrics: "Recipe rating correlation analysis"
    }
  ],
